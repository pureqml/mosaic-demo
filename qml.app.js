...
var _this$child0 = new $src.AppApi($this)
		$c._this$child0 = _this$child0
...
//=====[component controls.experimental.NestedVideo]=====================
	...
	var NestedVideoBaseComponent = $core.VideoPlayer
	var NestedVideoBasePrototype = NestedVideoBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.VideoPlayer}
 */
	...
	NestedVideoPrototype.showPlayerAt = function(x,y) {
		this.x = x
		this.y = y
		this.visible = true
		this.display = true
...
//assigning width to (((290) * ${context.virtualScale}))
			$this._replaceUpdater('width', function() { $this.width = (((290) * $this._context.virtualScale)) }, [$this._context,'virtualScale'])
//assigning height to (((170) * ${context.virtualScale}))
			$this._replaceUpdater('height', function() { $this.height = (((170) * $this._context.virtualScale)) }, [$this._context,'virtualScale'])
...
//assigning autoPlay to (true)
			$this._removeUpdater('autoPlay'); $this.autoPlay = (true);
...
$this.delegate = (function(__parent, __row) {
		var delegate = new $controls$web.WebItem(__parent, __row)
